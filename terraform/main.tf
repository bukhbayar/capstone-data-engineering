...
#     su - airflow -c "source ~/venv/bin/activate && pip install psycopg2-binary && pip install 'apache-airflow-providers-dbt-cloud==4.0.0'"

#     # Install Airflow and dependencies
#     su - airflow -c "source ~/venv/bin/activate && pip install \
#         'apache-airflow==2.9.2' \
#         'apache-airflow[amazon,postgres,celery,redis]==2.9.2' \
#         'apache-airflow-providers-dbt-cloud==4.0.0' \
#         'apache-airflow-providers-common-sql==1.10.0' \
#         'apache-airflow-providers-standard' \
#         'psycopg2-binary'"

#     # Redis
#     su - airflow -c "source ~/venv/bin/activate && pip install 'apache-airflow[amazon,postgres, celery,redis]==2.9.2'"
